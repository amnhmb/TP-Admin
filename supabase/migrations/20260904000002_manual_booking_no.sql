...
DROP FUNCTION IF EXISTS create_booking(TEXT, TEXT, DATE, DATE, TEXT, TEXT, UUID, TEXT, JSONB);

-- Create new signature with p_booking_no
...
REVOKE EXECUTE ON FUNCTION create_booking(TEXT, TEXT, DATE, DATE, TEXT, TEXT, UUID, TEXT, JSONB, TEXT) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION create_booking(TEXT, TEXT, DATE, DATE, TEXT, TEXT, UUID, TEXT, JSONB, TEXT) FROM anon;
GRANT EXECUTE ON FUNCTION create_booking(TEXT, TEXT, DATE, DATE, TEXT, TEXT, UUID, TEXT, JSONB, TEXT) TO authenticated;
